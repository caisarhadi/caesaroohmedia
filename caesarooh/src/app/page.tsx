...
export default function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 py-20 md:py-28 lg:py-32 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mb-8 font-medium animate-fade-in-delay">
              ...
              fallback={
                <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-secondary/20 flex items-center justify-center">
                  <div className="text-center p-8">
                    <div className="text-4xl font-bold text-gray-800 dark:text-white mb-2">Billboard Showcase</div>
                    <p className="text-gray-600 dark:text-gray-300">Premium Advertising Locations</p>
                  </div>
                </div>
              }
            />
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute -top-24 -left-24 bg-primary/10 dark:bg-primary/20 rounded-full w-96 h-96 blur-3xl"></div>
          <div className="absolute -bottom-32 -right-32 bg-secondary/10 dark:bg-secondary/20 rounded-full w-96 h-96 blur-3xl"></div>
        </div>
      </section>
                ...
                <ResponsiveImage 
                  ...
                  fallback={
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-indigo-500/20 flex items-center justify-center">
                      <div className="text-center p-8">
                        <div className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Data-Driven Advertising</div>
                        <p className="text-gray-600 dark:text-gray-300">Analytics and Insights</p>
                      </div>
                    </div>
                  }
                />
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8 items-center justify-items-center">
            ...
            {[1, 2, 3, 4, 5].map((item) => (
              <div key={item} className="bg-gray-100 dark:bg-gray-800 h-24 w-40 rounded-lg flex items-center justify-center">
                <div className="text-gray-400 dark:text-gray-500 text-sm font-medium">CLIENT LOGO</div>
              </div>
            ))}
          </div>
